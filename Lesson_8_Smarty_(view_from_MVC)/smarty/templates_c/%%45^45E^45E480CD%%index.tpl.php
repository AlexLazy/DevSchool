<?php /* Smarty version 2.6.25-dev, created on 2016-04-03 20:56:15
...
<form  method="POST">
    ...
    <div class="input-group">
        ...
        <input required type="text" maxlength="40" pattern="(\D+)" class="form-control" value='<?php echo $this->_tpl_vars['seller_name']; ?>
